...
const MenuMaterialPage = () => {
  ...
  const { data } = useSelector((state) => state.menuMaterial);
  ...
  const filterMenu = (text) => {
    ...
    try {
      ...
      WHERE {
        ?makanan rdf:type md:${slug === 'hidanganUtama'? 'hidanganaUtama' : slug } .
            ...
            <ol className="inline-flex items-center space-x-1 md:space-x-3">
              ...
              { slug? (<li>
                <div className="flex items-center">
                  ...
                  <Link to={`/healthy-recipes/${slug}`} className="ml-1 text-lg font-medium text-black hover:text-gray-900 dark:text-old-gold">
